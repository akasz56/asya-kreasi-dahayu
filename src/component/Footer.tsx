...
export default function Footer() {
  return (
    <footer className="bg-asya-dark">
      <div className="container flex justify-between items-center mx-auto py-16">
        <h2 className="uppercase text-asya-light text-3xl font-medium tracking-widest">
          Asya Kreasi Dahayu
        </h2>
        <div className="space-y-12">
          <p className="text-asya-light text-md font-medium tracking-widest">
          ...
          <div className="relative">
            <label
              htmlFor="email"
              className="text-asya-light text-md font-medium tracking-widest"
            >
              Email Address
            </label>
            <input
