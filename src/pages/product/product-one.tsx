...
export default function ProductOne() {
  return (
    <div className="asya-container">
      <section id="product" className="h-screen flex py-32">
        <div className="w-1/2">
          <Image
            src={"/images/hero.jpg"}
            alt={"image"}
      ...
      <section id="related" className="my-28">
        <h2 className="uppercase text-center text-asya-dark text-4xl font-bold tracking-widest">
          Related Product
        </h2>
