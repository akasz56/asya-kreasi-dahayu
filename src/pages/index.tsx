...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <p className="text-center text-white text-5xl font-medium tracking-widest leading-normal">
      ...
      <section id="about" className="bg-asya-dark">
        <div className="flex container mx-auto py-20">
          <h2 className="flex-1 self-center uppercase text-white text-5xl font-medium tracking-widest">
            About Us
          </h2>
          <p className="w-2/3 text-white font-light tracking-widest leading-relaxed">
      ...
      <section id="service">
        <div className="container mx-auto">
          <div className="flex py-20">
            <h2 className="flex-1 self-center uppercase text-asya-dark text-5xl font-medium tracking-widest">
              Our Services
            </h2>
            <p className="w-2/3 text-asya-dark font-light tracking-widest leading-relaxed">
          ...
          <div className="mb-28 grid grid-cols-2 gap-16">
            {services.map((item, key) => (
              <Link key={key} href={"#"}>
                ...
                <p className="mt-20 text-asya-dark text-sm tracking-widest">
